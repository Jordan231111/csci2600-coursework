// Dafny program problem2.dfy compiled into C#
...
// Command-line arguments: run --no-verify /Users/jordan/Documents/PSoftHwDirectory/csci2600-hw2/answers/problem2.dfy
// problem2.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger altSum(BigInteger n)
    {
      ...
      while ((_0_i) < (n)) {
        ...
        if ((Dafny.Helpers.EuclideanModulus(_0_i, new BigInteger(2))).Sign == 0) {
          t = (t) + (_0_i);
        } else {
          t = (t) - (_0_i);
        }
    ...
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_res0;
      BigInteger _out0;
      _out0 = __default.altSum(BigInteger.Zero);
      _0_res0 = _out0;
      BigInteger _1_res1;
      BigInteger _out1;
      _out1 = __default.altSum(BigInteger.One);
      _1_res1 = _out1;
      BigInteger _2_res2;
      BigInteger _out2;
      _out2 = __default.altSum(new BigInteger(2));
      _2_res2 = _out2;
      BigInteger _3_res3;
      BigInteger _out3;
      _out3 = __default.altSum(new BigInteger(3));
      _3_res3 = _out3;
      BigInteger _4_res6;
      BigInteger _out4;
      _out4 = __default.altSum(new BigInteger(6));
      _4_res6 = _out4;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("altSum(0) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_res0));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("altSum(1) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_res1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("altSum(2) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_res2));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("altSum(3) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_res3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("altSum(6) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_4_res6));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
