// Dafny program problem3.dfy compiled into C#
...
// Command-line arguments: run --no-verify /Users/jordan/Documents/PSoftHwDirectory/csci2600-hw2/answers/problem3.dfy
// problem3.dfy
...
namespace _module {
  ...
  public partial class __default {
    public static BigInteger loopysqrt(BigInteger n)
    {
      ...
      _0_a = n;
      while ((_0_a).Sign == 1) {
        root = (root) + (BigInteger.One);
        _0_a = (_0_a) - (((new BigInteger(2)) * (root)) - (BigInteger.One));
      }
      return root;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      BigInteger _0_result1;
      BigInteger _out0;
      _out0 = __default.loopysqrt(new BigInteger(4));
      _0_result1 = _out0;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("loopysqrt(4) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_result1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _1_result2;
      BigInteger _out1;
      _out1 = __default.loopysqrt(new BigInteger(25));
      _1_result2 = _out1;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("loopysqrt(25) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_1_result2));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _2_result3;
      BigInteger _out2;
      _out2 = __default.loopysqrt(new BigInteger(30));
      _2_result3 = _out2;
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("loopysqrt(30) = ")).ToVerbatimString(false));
